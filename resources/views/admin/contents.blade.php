                ...
                <div class="col-md-5">
                    <div class="card">
                        <div class="card-block">
                            ...
                            <form method="post" action="{{route('post.content')}}">
                                {!! csrf_field() !!}
                                <input type="hidden" name="collection_id" value="{{$collection->id}}">
                                <fieldset class="form-group"> <label class="control-label" for="formGroupExampleInput">项目标题</label> <input type="text" class="form-control" id="formGroupExampleInput" name="name"> </fieldset>
                                <fieldset class="form-group"> <label class="control-label" for="formGroupExampleInput">链接文章ID</label> <input type="text" class="form-control" id="formGroupExampleInput" name="link"> </fieldset>
