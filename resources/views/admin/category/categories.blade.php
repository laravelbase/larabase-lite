                                        ...
                                        @forelse($categories as $category)
                                            <tr class="odd gradeX">
                                               {{-- <td><input type="checkbox"></td>--}}
                                                ...
                                                <td class="actions">
                                                    @include('admin.category.actions',$category)
                                                </td>
                                            </tr>
                                            <tr>
                    ...
                    <div class="card">
                        <div class="card-block">
                            ...
                            <form method="post" action="{{route('post.category')}}">
                                ...
                                <fieldset class="form-group"> <label class="control-label" for="formGroupExampleInput">分类名称</label> <input type="text" class="form-control" id="formGroupExampleInput" name="name"> </fieldset>
                                <fieldset class="form-group"> <label class="control-label" for="formGroupExampleInput">链接</label> <input type="text" class="form-control" id="formGroupExampleInput" name="link"> </fieldset>
                                    ...
                                    <select class="form-control" name="parent_id">
                                        ...
                                        <option value="{{$category->id}}">{{$category->name}}</option>
                                            @if($children = $category->children and $children->count() > 0)
                                                ...
                                                @include('admin.category.treeChildren_select',$children)
                                            @endif
                                         @empty
