...
@section('custom_css')
    ...
    <link rel="stylesheet" href="/assets/css/tree/tree.css">
    <style>
            ...
            <section class="mdl-grid ">
                ...
                <div class="mdl-cell mdl-cell--7-col">
                    <div class="demo-crumbs mdl-color-text--grey-500">
                        <a href="/">首页</a> &gt; <a href="{{route('collection.post',['col_id'=>$collection->id,'post_id'=>$post->id])}}">{{$collection->name}}</a> &gt;
                        {{$post->title}}
                    </div>
                    <h3>{{$post->title}}</h3>
                    <div class="post-meta">
                ...
                <div class="mdl-cell mdl-cell--2-col" style="padding-top: 109px;">
...
{{--<pre>@{{ $data.total_comments_count |json  }}</pre>--}}
    </main>
